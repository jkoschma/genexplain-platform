...
![](new_images/how_it_works/how_it_works1.png)
...
![](new_images/how_it_works/how_it_works3.png)
...
![](new_images/how_it_works/how_it_works5.png)
...
![](new_images/how_it_works/how_it_works7.png)
![](new_images/how_it_works/how_it_works8.png)
...
![](new_images/how_it_works/how_it_works9.png)
...
Your account information will be displayed in the workspace as shown below:
...
![](new_images/how_it_works/how_it_works20.png)
...
![](new_images/how_it_works/how_it_works24.png)
...
![](new_images/how_it_works/how_it_works26.png)

The form opens as shown below:

<!-- ![](media/6b6b92ec03e761ad35f862bc5f5bf240.png) -->

![](new_images/how_it_works/how_it_works27.png)
...
Important to note, this change is applied for one selected project, the project name is shown on the top of the form. If you have several projects, you can fix database versions for each project individually.
...
![](new_images/how_it_works/how_it_works29.png)
...
![](new_images/how_it_works/how_it_works33.png)
...
![](new_images/how_it_works/how_it_works35.png)
...
Diagrams can be zoomed in and zoomed out, by clicking on the buttons <!-- ![](media/65b191751b9996cc91860bdf1bdc58f0.png) or ![](media/8ae7724b79ee5f10a8cfc01ef9fd5a04.png),--> ![](new_images/how_it_works/how_it_works38.png) correspondingly.

They can be exported in several formats by clicking the button <!-- ![](media/2fde7d826d1a2a88928490c9133c4556.png) --> ![](new_images/how_it_works/how_it_works39.png),
<!-- ![](media/dc11c551d7ef6d67cc48328930b74dcd.png) -->
![](new_images/how_it_works/how_it_works40.png)

Diagrams can be zoomed in and zoomed out, by clicking on the buttons <!-- ![](media/b59c404c4487a1135a2eab98e0bde155.png) or ![](media/56e2b324f8d8ed08a3d6c714982a193b.png) --> ![](new_images/how_it_works/how_it_works38.png) respectively.
