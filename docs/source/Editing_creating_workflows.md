...
![](new_images/workflows_editing/workflows_editing1.png)
...
To create your own workflow, please go to the folder where you want to create workflow and right click on the folder and choose “Create your own workflow” from the context menu. You will be asked to specify the name of the new workflow.

![](new_images/workflows_editing/workflows_editing1.png)

In this example, an entry *New workflow* (default name) will be created.

You will see a new tab being opened in the Work Space, where you can design
...
![](new_images/workflows_editing/workflows_editing3.png)
...
![](new_images/workflows_editing/workflows_editing4.png)
...
![](new_images/workflows_editing/workflows_editing5.png)

**Step 2.** For creating the input table you should click on the green element
in the toolbar, locate the cursor in the Work Space where you would like to put
...
![](new_images/workflows_editing/workflows_editing6.png)
...
![](new_images/workflows_editing/workflows_editing7.png)
...
on the “Table” element in the Work Space you select it as the Input node for this
...
![](new_images/workflows_editing/workflows_editing8.png)

After pressing “OK” a new connection is created:

![](new_images/workflows_editing/workflows_editing9.png)

**Step 4.** The same way you can create now an output table element on the
diagram by selecting the yellow element in the toolbar (since it is going to be
...
![](new_images/workflows_editing/workflows_editing10.png)
...
![](new_images/workflows_editing/workflows_editing11.png)
...
![](new_images/workflows_editing/workflows_editing15.png)

<!--
![](media/abb28e26c5f7a0a74ef8433b3655c7ce.png)

**Note** During execution of the workflow a *research diagram* is saved (you
can specify the name of this diagram before starting off the workflow). The
...
the “cycle” button in the toolbar. It is necessary to specify the Name of the
cycle (the “cycle variable”), and to choose the appropriate Type and Cycle type.

![](new_images/workflows_editing/workflows_editing16.png)
...
![](new_images/workflows_editing/workflows_editing17.png)
...
![](media/0e7982d74044921c309449b9b8015cd2.png),
...
![](media/754657fca0f79a4938c3530aefebb388.png)

## Run GO classification for all tables in a folder

![](media/e2a062cee5fd172e274d346a8f96465f.png)
...
![](media/a4bd079883f97c9df0134fd60f9e809d.png)
...
![](media/29b9fa8c15eccc6a48fa6a3a46c82a2d.png)

The conversion result is taken as input set in the Functional classification
analysis:

![](media/77be7c04be09e42f038a29e2a60a1a6e.png)
...
![](media/ce35274674406a29e28aea0fc66343aa.png)

![](media/73324df2205de707707aad60f8967268.png)
