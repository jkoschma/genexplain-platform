...
[example input]: https://platform.genexplain.com/bioumlweb/#de=data/Examples/User%20Guide/Data/Input%20for%20examples/CRC%20clustering
...
[input table]: https://platform.genexplain.com/bioumlweb/#de=data/Examples/User%20Guide/Data/Input%20for%20examples/Upregulated%20Ensembl%20genes%20filtered%20(logFC%3E1)
...
The method is run using a set of [upregulated genes] from brain tumor as input, specifying brain: normal as cell tissue condition, and keeping all other conditions as default.
...
[**input**]: https://platform.genexplain.com/bioumlweb/#de=data/Examples/User%20Guide/Data/Input%20for%20examples/Upregulated%20Ensembl%20genes%20filtered%20(logFC%3E1)%20Transcripts%20Ensembl
...
[input table]: https://platform.genexplain.com/bioumlweb/#de=data/Examples/User%20Guide/Data/Input%20for%20examples/Upregulated%20Ensembl%20genes
...
[Input track]:https://platform.genexplain.com/bioumlweb/#de=data/Examples/User%20Guide/Data/Input%20for%20examples/GSE135254_RAW/GSM3999730_H1hESC_SMAD1_untreated_ChIP_peaks
...
[Input]: https://platform.genexplain.com/bioumlweb/#de=data/Examples/User%20Guide/Data/Input%20for%20examples/Upregulated%20Ensembl%20genes%20filtered%20(logFC%3E1)
...
The method Intersect tracks provides two types of operations whose results are either the
intersection itself or the difference of two tracks. In the first instance the
...
### Gene set to track
### Group table rows
### Import from BC Platform
### Import from TranSMART
### Intersect tables
### Intersect tracks
### Join full tables
### Join several tables
...
[Example folder]: <https://platform.genexplain.com/bioumlweb/#de=data/Examples/User%20Guide/Data/Input%20for%20examples/Upregulated%20Ensembl%20genes%20filtered%20(logFC%3E1)>


**Step 2.** Input pre-saved No set. You can drag-and-drop as usual. Here, the
set of human housekeeping genes from the Public folder is used as input No set,
...
[output]: <https://platform.genexplain.com/bioumlweb/#de=data/Examples/User%20Guide/Data/Examples%20of%20methods/Site%20analysis/Upregulated%20Ensembl%20genes%20filtered%20(logFC%3E1)%20sites%20-1000..100/summary>
...
are shown as a track ![](media/d5eeb5ca90cb5d665ad192f9464ccf54.png). 
