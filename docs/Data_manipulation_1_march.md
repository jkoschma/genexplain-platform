...
Consider the list of [Ensembl_transcripts] as input, keeping all other parameters as default, launch the analysis by pressing 'RUN' [Output transcript track file] is opened by default in the genome browser. 
